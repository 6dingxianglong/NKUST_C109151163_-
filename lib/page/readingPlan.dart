          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("大一", style: TextStyle(fontSize: 20,)),
                const Text("1.紮實基礎課程（如計算機概論、物件導向程式設計、資訊系統原理、資料結構等）。"
                ...
                SizedBox(height: 20,),
                Text("大二",style: TextStyle(fontSize: 20,)),
                const Text("1.持續紮實資訊基礎課程，嘗試跨領域基礎課程。\n"
                ...
                SizedBox(height: 20,),
                Text("大三",style: TextStyle(fontSize: 20,)),
                const Text("1.學習初步的SQL語法，加強我資料庫處理能力。\n"
                ...
                SizedBox(height: 20,),
                Text("大四",style: TextStyle(fontSize: 20,)),
                const Text("1.進行整合型及跨領域專題研究。\n"
                    "2.為研究所考試作準備。\n"
                    "3.取實習機會。",
                    style: TextStyle(fontSize: 15,)
                ),
                SizedBox(height: 20,),
                Text("遠程（畢業以後）",style: TextStyle(fontSize: 20,)),
                const Text("1.考取國內或國外的資訊相關研究所。\n"
                    "2.投入雲端資訊產業，累積實質經驗\n"
